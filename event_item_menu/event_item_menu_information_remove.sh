...
event_menu["$item_menu_remove_carma"]="fly-term -e 'sudo apt remove carma-capilite carma-dev carma-common -y'"
event_menu["$item_menu_remove_carma"]="remove_app 'simplescreenrecorder'"
